...
#### Module 2: Working with AI Coding Tools
- Introduction to popular AI coding tools
  - GitHub Copilot
  - Cursor AI
  - ChatGPT for coding
...
#### Module 3: Practical Vibe Coding Techniques
- Generating code with AI assistants
- Refactoring code using AI
- Debugging with AI support
- Code documentation and explanation
- Test generation and validation

#### Module 4: Hands-On Lab - Building Your First AI-Assisted Project
- Project setup with AI assistance
- Implementing features using prompts
